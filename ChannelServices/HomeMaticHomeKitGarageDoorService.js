  ...
  .on('set', function(value,callback) {
    ...
    if ((that.address_actor_open != undefined) && (that.address_actor_close == undefined)) {
      ...
      if (value == Characteristic.TargetDoorState.OPEN) {
        ...
        that.currentDoorState.updateValue(that.characteristic.CurrentDoorState.CLOSING,null)
        that.sendActorMessage(that.message_actor_close,that.message_actor_close['on'])
        that.sendActorMessage(that.message_actor_close,that.message_actor_close['off'],that.delay_actor_close)
