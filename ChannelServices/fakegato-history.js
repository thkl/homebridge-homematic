              ...
              if (this.usedMemory < this.memorySize) {
                val = Format(
                  ...
                  if (this.service === undefined) { // Accessory API
                    ...
                    this.log.debug("FakeGato PlattformAPI %s",val);
                  ...
                  if(this.storage !== undefined) {
                    ...
                    this.log.error("FakeGato storage is not set ?");
                  }
                } else {
                ...
                homebridge.globalFakeGatoStorage.read({
                  ...
                  callback: function(err,data){
                    if(!err) {
                      if(data) {
                        try {
                          this.log.debug("read data from",this.accessoryName,":");
